...
function deleteBill(obj){
	$.ajax({
		type:"GET",
		url:path+"/deleteByIdBuill.action",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/queryByIdBuill.action?billid="+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/upateBuill.action?billid="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
