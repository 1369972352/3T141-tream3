...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="get" action="${pageContext.request.contextPath }/addBuill.action">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/billadd.js">
