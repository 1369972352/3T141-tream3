...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/queryProvider.action">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerLists }" varStatus="status">
				<tr>
					<td>
	...
	<input type="hidden" id="totalPageCount" value="${totalCount}"/>
